...
#ifndef _PSX_MINECRAFT__GAME_WORLD_LEVEL__OVERWORLD_FLATLAND_H_
#define _PSX_MINECRAFT__GAME_WORLD_LEVEL__OVERWORLD_FLATLAND_H_
...
#endif // _PSX_MINECRAFT__GAME_WORLD_LEVEL__OVERWORLD_FLATLAND_H_