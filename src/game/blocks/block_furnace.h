...
#define FURNACE_FIRE_TEXTURE_HEIGHT 15
...
#define FURNACE_FIRE_TEXTURE_POS_X (CENTRE_X - (FURNACE_TEXTURE_WIDTH >> 1) + 55)
...
#define FURNACE_ARROW_TEXTURE_POS_X (CENTRE_X - (FURNACE_TEXTURE_WIDTH >> 1) + 79)
#define FURNACE_ARROW_TEXTURE_POS_Y (CENTRE_Y - (FURNACE_TEXTURE_HEIGHT >> 1) + 35)
