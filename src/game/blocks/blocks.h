...
/*#define blockCanSunLightPropagate(id) ((id) < BLOCKTYPE_SOLID || (id) > BLOCKTYPE_SLAB)*/
/*#define blockCanSunLightNotPropagate(id) ((id) >= BLOCKTYPE_SOLID && (id) <= BLOCKTYPE_SLAB)*/
/*#define blockCanBlockLightPropagate(id) ((id) < BLOCKTYPE_SOLID || (id) > BLOCKTYPE_SLAB)*/
/*#define blockCanBlockLightNotPropagate(id) ((id) >= BLOCKTYPE_SOLID && (id) <= BLOCKTYPE_SLAB)*/
