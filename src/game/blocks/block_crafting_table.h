...
#define CRAFTING_TABLE_SLOT_GROUP_ORIGIN_X 102
#define CRAFTING_TABLE_SLOT_GROUP_ORIGIN_Y 54
...
#define CRAFTING_TABLE_RESULT_SLOT_GROUP_ORIGIN_X 196
#define CRAFTING_TABLE_RESULT_SLOT_GROUP_ORIGIN_Y 73
